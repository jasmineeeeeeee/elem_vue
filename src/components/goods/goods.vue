<template>
  <div class="goods">
    ...
    <!--从父组件goods.vue中传数据给子组件food.vue，子组件在props[]中接收-->
    <!--引入【foods详情页】组件-->
...
//    })
  ...
  methods: {
    ...
    _calculateHeight () {
      /*首先获取到右边内容盒子的高度，然后获取到该盒子中每一项的高度并做前n项高度累加（第n项的高度是前n项的高度和）存储到listHeight数组中*/
    ...
    selectMenu (index) {
      ...
      this.foodsScroll.scrollToElement(ref, 300)/*滚动到的目标元素，执行时间*/
    },
    selectFood (food) {
